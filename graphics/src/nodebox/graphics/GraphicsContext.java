...
import nodebox.node.StringPort;
...
public interface GraphicsContext {
    ...
    public static enum VarType {
        NUMBER(FloatPort.class),
        TEXT(StringPort.class),
        BOOLEAN(BooleanPort.class),
        FONT(StringPort.class);

        public final Class<? extends Port> portClass;

        VarType(Class<? extends Port> portClass) {
