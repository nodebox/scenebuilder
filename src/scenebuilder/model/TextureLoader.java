...
public class TextureLoader {
     ...
     */
    public GLImage getTexture(File file) throws IOException {
        GLImage tex = (GLImage) table.get(file);
     ...
     * @throws IOException Indicates a failure to access the resource
     */
    public GLImage getTexture(File file,
                              int target,
                              int dstPixelFormat,
                              int minFilter,
        ...
        GLImage texture = new GLImage(target, textureID);
     ...
     */
    private ByteBuffer convertImageData(BufferedImage bufferedImage, GLImage texture) {
